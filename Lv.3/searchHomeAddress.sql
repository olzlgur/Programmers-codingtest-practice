...
FROM USED_GOODS_USER A, (SELECT WRITER_ID, COUNT(*) AS CNT FROM USED_GOODS_BOARD GROUP BY WRITER_ID HAVING 3 <= CNT) B
WHERE A.USER_ID = B.WRITER_ID ORDER BY A.USER_ID DESC